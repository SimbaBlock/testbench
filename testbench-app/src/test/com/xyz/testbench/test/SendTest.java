...
public class SendTest {
    ...
    // 创建发送，协议不匹配测试,是否会销毁
    @Test
    public void createSendTokenIdTest() throws Exception {
        ...
        Map<String, String> yquery = new HashedMap();
        yquery.put("address", "13e3v3E2CYzaiFWhL3iKMpiuYPXiGNbpAc");

        String utreulst = HttpUtil.doPost("http://47.110.137.123:8433/rest/Api/getUtxo", yquery);
        JSONObject utob = (JSONObject) JSONObject.parse(utreulst);
        JSONObject utdata = utob.getJSONObject("data");
        JSONArray ututxos = utdata.getJSONArray("utxo");
        BigDecimal utsumValue = new BigDecimal("0");
        for (Object o : ututxos) {
            ...
            Integer n = utxo.getInteger("n");
            BigDecimal value = new BigDecimal(utxo.getString("value"));
            utsumValue = utsumValue.add(value);
            TxInputDto TxInputDto = new TxInputDto(txid, n, "");
            inputList.add(TxInputDto);
        ...
        BigDecimal fee = new BigDecimal("0.000005");
        BigDecimal cost = new BigDecimal("0.00001");
        BigDecimal value = utsumValue.add(sumValue).subtract(fee).subtract(cost).subtract(cost);                                //newAmout.toString(16)
        CommonTxOputDto txOutputDto1 = new CommonTxOputDto(Address2, cost,"06534c502b2b000202010453454e4420f613da5785cfcfbb5c4d47e8dd11156712c8b9fa169881ec4c805ea4f6f1b6b608"+"0000000000001388",1);
        CommonTxOputDto txOutputDto2 = new CommonTxOputDto(address1, cost,"06534c502b2b000202010453454e4420f613da5785cfcfbb5c4d47e8dd11156712c8b9fa169881ec4c805ea4f6f1b6b608"+"00470de4df81ec78",1);        // token找零
